class DialoguePanel extends dessert.DisplayObjectContainer implements Observer {

	private textField: dessert.TextField;
	private taskField: dessert.TextField;
	private button: dessert.TextField;
	private wordPanel: dessert.Shape;
	//	priate
	public height = 400;
	public width = 400;
	...
	public constructor(npcId: string, _stage: any, statemachine: StateMachine) {
		...
		this.taskField = new dessert.TextField();
		...
		this.button.addEventListener(dessert.MouseState.MOUSE_CLICK, () => {
